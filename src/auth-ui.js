...
import { saveDome, loadDomeById, getUserDomes, deleteDome, generateDomeId, getShareUrl, checkDomeNameExists } from './services/dome-storage';
...
import { trackSignInAttempt, trackSignInSuccess, trackSignOut, trackDomeSave, trackDomeLoad, setAnalyticsUserId, trackButtonClick, trackDomeDelete, trackShareUrlCopied, trackSaveActionClick } from './services/analytics';
...
export function initAuthUI(faceDataGetter, faceDataSetter, loadTempUnsavedChanges) {
    return __awaiter(this, void 0, void 0, function* () {
        // Check if we're completing sign-in from email link
        yield checkEmailLink();
        ...
        shareButton.addEventListener('click', (e) => {
            ...
            if (currentDomeId) {
                ...
                navigator.clipboard.writeText(shareUrl).then(() => {
                    ...
                    trackShareUrlCopied(currentDomeId, ((_a = getCurrentUser()) === null || _a === void 0 ? void 0 : _a.uid) || null);
                    setTimeout(() => {
...
function setupLoginModal() {
    ...
    loginButton === null || loginButton === void 0 ? void 0 : loginButton.addEventListener('click', () => {
        ...
        trackButtonClick('login_button', (user === null || user === void 0 ? void 0 : user.uid) || null);
...
function setupSaveModal(faceDataGetter) {
    ...
    saveDomeButton === null || saveDomeButton === void 0 ? void 0 : saveDomeButton.addEventListener('click', () => {
        ...
        const user = getCurrentUser();
        trackButtonClick('save_dome_button', (user === null || user === void 0 ? void 0 : user.uid) || null);
        if (!isAuthenticated()) {
    ...
    const handleSave = (isCopy) => __awaiter(this, void 0, void 0, function* () {
        var _a;
        ...
        let domeName = domeNameInput === null || domeNameInput === void 0 ? void 0 : domeNameInput.value.trim();
        if (!domeName) {
        ...
        if (isCopy) {
            const exists = yield checkDomeNameExists(domeName);
            if (exists) {
                const shouldAppendCopy = confirm(`A dome named "${domeName}" already exists in your account.\n\n` +
                    `Do you want to save this as "${domeName} (Copy)" instead?`);
                if (shouldAppendCopy) {
                    domeName = `${domeName} (Copy)`;
                    // Update input to reflect new name
                    if (domeNameInput)
                        domeNameInput.value = domeName;
                }
                else {
        ...
        const originalButtonText = (buttonToDisable === null || buttonToDisable === void 0 ? void 0 : buttonToDisable.textContent) || 'Save';
        if (buttonToDisable) {
        ...
        else if (currentDomeId && currentDomeOwnerId === (user === null || user === void 0 ? void 0 : user.uid)) {
            saveType = 'overwrite';
        }
        if (result.success && result.domeId) {
            ...
            trackDomeSave(result.domeId, domeName, faceData.size, isPublic, (user === null || user === void 0 ? void 0 : user.uid) || null, saveType);
    ...
    confirmButton === null || confirmButton === void 0 ? void 0 : confirmButton.addEventListener('click', () => {
        var _a;
        trackSaveActionClick('save', ((_a = getCurrentUser()) === null || _a === void 0 ? void 0 : _a.uid) || null);
        handleSave(false);
    });
    // Save as Copy
    saveAsCopyButton === null || saveAsCopyButton === void 0 ? void 0 : saveAsCopyButton.addEventListener('click', () => {
        var _a;
        trackSaveActionClick('save_as_copy', ((_a = getCurrentUser()) === null || _a === void 0 ? void 0 : _a.uid) || null);
        handleSave(true);
    });
    // Copy share URL
    copyButton === null || copyButton === void 0 ? void 0 : copyButton.addEventListener('click', () => {
        ...
        const user = getCurrentUser();
        if (currentDomeId) {
            trackShareUrlCopied(currentDomeId, (user === null || user === void 0 ? void 0 : user.uid) || null);
        }
        if (shareUrlInput) {
...
function setupLoadModal(faceDataSetter) {
    ...
    loadDomeButton === null || loadDomeButton === void 0 ? void 0 : loadDomeButton.addEventListener('click', () => __awaiter(this, void 0, void 0, function* () {
        ...
        const user = getCurrentUser();
        trackButtonClick('load_dome_button', (user === null || user === void 0 ? void 0 : user.uid) || null);
        if (!isAuthenticated()) {
            alert('Please sign in first');
            return;
        }
...
function displayDomeList(domes, faceDataSetter) {
    ...
    domes.forEach((dome) => {
        ...
        deleteBtn === null || deleteBtn === void 0 ? void 0 : deleteBtn.addEventListener('click', (e) => __awaiter(this, void 0, void 0, function* () {
            ...
            // Track dome deletion
            const user = getCurrentUser();
            trackDomeDelete(dome.id, dome.name, (user === null || user === void 0 ? void 0 : user.uid) || null);
...
function loadDomeData(domeId, faceDataSetter) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (result.success && result.dome) {
            ...
            const user = getCurrentUser();
            trackDomeLoad(dome.id, dome.name, (user === null || user === void 0 ? void 0 : user.uid) || null);
            // Save to session storage for restoration on refresh
...
function getUrlWithPreservedParams(...paramsToRemove) {
    const urlParams = new URLSearchParams(window.location.search);
